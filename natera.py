...
#=============================================================================================
#desired_cap = {'os': 'Mac', 'os_version': 'OS X: Sierra', 'browser': 'Chrome', 'browser_version': '87.0' }
#desired_cap = {
# 'browserName': 'iPhone',
# 'device': 'iPhone 11',
# 'realMobile': 'true',
# 'os_version': '14.0',
# 'name': 'NATERA-[Python] Test', 
# 'build': 'NATERA Build 1' # CI/CD job or build name
#}

#driver = webdriver.Remote(
#command_executor='https://scottmaretick2:MDKicy4nya2192zewKpz@hub-cloud.browserstack.com/wd/hub', #desired_capabilities=desired_cap)
